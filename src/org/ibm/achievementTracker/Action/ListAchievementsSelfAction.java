...
public class ListAchievementsSelfAction extends ActionSupport implements
		SessionAware {

	private static final long serialVersionUID = 1L;
	private Map<String, Object> sessionMap;
	private List<AchievementBean> achievementBeanList;
	private Logger logger = Logger.getLogger(ListAchievementsSelfAction.class);
	...
	public String init() {
		...
		try {
			achievementVOs = proxy.findAchievementByEmpID(employeeid);
